...
//   try {
//     const { ad_name, password, phone, role } = req.body;
...
//     // agar is_used true bo‘lsa qayta kirishga ruxsat bermaymiz
//     if (admin.is_used) {
//       return res.status(400).json({
//         success: false,
//         message:
//           "Bu admin allaqachon tizimga kirgan. Qayta kirish mumkin emas.",
//       });
//     }
...
//     // birinchi marta kirganda parolni hash qilamiz
//     const hashedPassword = await bcrypt.hash(password, 10);
