...
const { authAdmin, checkRole, isAdminMiddleware } = require("../middleware/isAdmin.middleware");
const { validateSchema } = require("../middleware/validate.middleware");

admin.post(
  "/first-super-admin",
  validateSchema(validateAdmin), adminController.createSuperAdmin
);
...
// admin.get("/profil", adminController.getProfile);



admin.get('/profile', isAdminMiddleware, adminController.getProfile);
// admin.get('/original', isAdminMiddleware, adminController.getOrdinaryAdmins);
