...
const Admin = () => {
  ...
  //   if (!token || !decoded) return; // Token yoki decoded bo‘lmasa — hech narsa qilmasin
  //   try {
  //     let response;
  ...
  //         // backend massiv yuborgan bo‘lsa
  //         if (Array.isArray(response.data)) {
  //           const updatedAdmin = { ...admin, cards: response.data };
  //           setAdmin(updatedAdmin);
  //           localStorage.setItem("admin", JSON.stringify(updatedAdmin));
  //         } else {
  //           // backend bitta admin obyekt yuborsa
  //           const adminObj = response.data.admin ?? response.data.user ?? response.data;
  //           setAdmin(adminObj);
  ...
  //     // Token muddati o‘tgan bo‘lsa — chiqib ketadi
  ...
  //       setToken("");
  //     } else {
  //       swalError("Xatolik", "Profil ma'lumotini olishda xatolik yuz berdi.");
  //     }
  //   }
  // };
